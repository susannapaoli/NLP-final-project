...
class TransformerTranslatorXLNET(nn.Module):
    """
    ...
    def __init__(self, input_size, output_size, device, pad_idx, N_layers, batch, hidden_dim=128, num_heads=2, dim_feedforward=2048, dim_k=96, dim_v=96, dim_q=96, max_length=43):
        ...
        """
        super(TransformerTranslatorXLNET, self).__init__()
...
# on decoder embeddings.
    ...
    def embed(self, inputs):
        ...
        xlnet_outputs = self.xlnet(inputs)[0]

        embeddings = torch.add(token_emb, positional_emb) + xlnet_outputs
        return embeddings
